...
import { authLimiter, aiLimiter, uploadLimiter } from '../middleware/rate-limit.js';
...
router.use('/agents', aiLimiter, agentRoutes);
...
router.use('/studio', aiLimiter, studioRoutes);
router.use('/subscriptions', subscriptionRoutes);
router.use('/cloud-import', uploadLimiter, cloudImportRoutes);
